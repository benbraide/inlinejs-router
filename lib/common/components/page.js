...
exports.RouterPageElementCompact = exports.RouterPage = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const names_1 = require("../names");
const base_page_1 = require("./base-page");
class RouterPage extends base_page_1.RouterBasePageElement {
    constructor() {
        super();
        this.id_ = '';
    }
    OnElementScopeCreated(_a) {
        ...
        this.HandleElementScopeCreated_(Object.assign({ componentId, scope }, rest), () => {
            ...
            const { onActive, onInactive } = pageData, pageId = (_a = (0, inlinejs_1.GetGlobal)().GetConcept(names_1.RouterConceptName)) === null || _a === void 0 ? void 0 : _a.AddPage({
                path: pageData.path,
                name: pageData.name,
...
function RouterPageElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(RouterPage);
}
