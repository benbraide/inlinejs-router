...
exports.RouterMountElementCompact = exports.RouterMount = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const names_1 = require("../names");
const base_1 = require("./base");
class RouterMount extends base_1.RouterElement {
    constructor() {
        super();
        this.onload_ = '';
        this.scroll_ = false;
    ...
    ResolvePath_(path) {
        const splitPath = (0, inlinejs_1.SplitPath)(path), context = {
            path: this.TryRelativePath_((0, inlinejs_1.TidyPath)(path)),
            base: this.TryRelativePath_(splitPath.base),
            query: splitPath.query,
        };
        return (0, inlinejs_1.ToString)((0, inlinejs_1.EvaluateLater)({ componentId: this.componentId_, contextElement: this, expression: this.format })(undefined, [], context));
    }
...
function RouterMountElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(RouterMount);
}
