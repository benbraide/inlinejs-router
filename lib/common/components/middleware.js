...
exports.RouterMiddlewareElement = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const path_1 = require("./path");
class RouterMiddlewareElement extends path_1.RouterPathElement {
    constructor() {
        super();
...
exports.RouterMiddlewareElement = RouterMiddlewareElement;
