...
exports.LinkRouterDirectiveExtension = (0, inlinejs_1.CreateDirectiveHandlerCallback)('link', ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    if (expression = expression.trim()) { //Listen for data loads
        let evaluate = (0, inlinejs_1.EvaluateLater)({ componentId, contextElement, expression }), isActive = false, dataSniffer = ({ path }) => {
            if (isActive != ((0, inlinejs_1.TidyPath)(path.base) === (0, inlinejs_1.TidyPath)(getPath()))) {
                evaluate(undefined, undefined, { active: (isActive = !isActive) });
            }
        };
        (_a = (0, inlinejs_1.GetGlobal)().GetConcept(names_1.RouterConceptName)) === null || _a === void 0 ? void 0 : _a.AddDataHandler(dataSniffer);
        (_c = (_b = (component || (0, inlinejs_1.FindComponentById)(componentId))) === null || _b === void 0 ? void 0 : _b.FindElementScope(contextElement)) === null || _c === void 0 ? void 0 : _c.AddUninitCallback(() => {
            var _a;
            (_a = (0, inlinejs_1.GetGlobal)().GetConcept(names_1.RouterConceptName)) === null || _a === void 0 ? void 0 : _a.RemoveDataHandler(dataSniffer);
        });
    }
});
