...
class RouterConcept {
    constructor(prefix_ = '', origin_ = '') {
        ...
        this.onEvent_ = e => (0, inlinejs_1.JournalTry)(() => this.Load_((e.state || this.mountPath_ || ''), false), 'InlineJS.RouterConcept.PopStateEvent');
    }
    GetOrigin() {
        return this.origin_;
    }
    ...
    Mount(load) {
        ...
        if (!load) {
            ...
            ((_a = this.current_.page) === null || _a === void 0 ? void 0 : _a.onActive) && (0, inlinejs_1.JournalTry)(() => { var _a; return this.current_.page.onActive(((_a = this.current_.page) === null || _a === void 0 ? void 0 : _a.id) || ''); }, 'InlineJS.RouterConcept.Mount');
            this.current_.page && window.dispatchEvent(new CustomEvent(`${names_1.RouterConceptName}.page`, { detail: { page: Object.assign({}, this.current_.page) } }));
            window.dispatchEvent(new CustomEvent(`${names_1.RouterConceptName}.path`, { detail: { path: Object.assign({}, split) } }));
        }
        else {
    ...
    Load_(path, pushHistory, shouldReload, data) {
        ...
        let joined = (0, inlinejs_1.JoinPath)(path), protocolHandlerResponse = (protocolHandler ? protocolHandler.handler({ protocol: protocolMatch[1], path: joined }) : null);
    ...
    DoLoad_(checkpoint, page, path, joined, protocolName, pushHistory, dataHandler) {
        ...
        if (!dataHandler) {
            if (page.id !== ((_a = this.current_.page) === null || _a === void 0 ? void 0 : _a.id)) { //New page
                ...
                this.current_.path = joined;
                this.current_.page && this.current_.page.onInactive && (0, inlinejs_1.JournalTry)(() => this.current_.page.onInactive(page.id), 'InlineJS.RouterConcept.Load');
                page.onActive && (0, inlinejs_1.JournalTry)(() => { var _a; return page.onActive(((_a = this.current_.page) === null || _a === void 0 ? void 0 : _a.id) || ''); }, 'InlineJS.RouterConcept.Load');
