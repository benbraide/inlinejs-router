...
export type RouterProtocolDataHandlerType = (data: string, path: ISplitPath) => void;
...
export type RouterProtocolHandlerResponseType = void | boolean | RouterProtocolDataHandlerType | IRouterProtocolModifyResponse;
export type ValidRouterProtocolHandlerResponseType = RouterProtocolDataHandlerType | IRouterProtocolModifyResponse;
